...
export interface CheckoutState {
  ...
  tax: number;
  total: number;
  paymentMethod: 'pi' | 'btc' | 'eth' | 'usdt' | 'tzs';
}
...
export function CheckoutForm({ items, onCheckoutComplete }: CheckoutFormProps) {
  ...
  const [paymentMethod, setPaymentMethod] = useState<'pi' | 'btc' | 'eth' | 'usdt' | 'tzs'>('pi');
  ...
  const paymentMethods = [
    {
      ...
      description: 'Fast and secure Pi transactions',
    },
    {
      id: 'btc',
      name: 'Bitcoin',
          ...
          <CardContent className="p-12 text-center">
            ...
            <div className="bg-white rounded-lg p-6 mb-6 space-y-4 text-left">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-lg font-bold text-amber-600">${(total / 1000000).toFixed(2)}M</span>
              </div>
              <div className="flex justify-between">
